...
fun createClientOpenApiTask(
    ...
    return tasks.create(getTaskName(apiName, "Client"),
        ...
        it.apiPackage.set("eu.phaf.openapi.$apiName.client.api")
        it.invokerPackage.set("eu.phaf.openapi.config")
        it.modelPackage.set("eu.phaf.openapi.$apiName.client.model")
...
fun createServerOpenApiTask(
    ...
    return tasks.create(getTaskName(apiName, "Server"),
        ...
        it.apiPackage.set("eu.phaf.openapi.$apiName.server.api")
        it.invokerPackage.set("eu.phaf.openapi.$apiName.invoke")
        it.modelPackage.set("eu.phaf.openapi.$apiName.model")
        it.ignoreFileOverride.set("$projectDir/.openapi-generator-ignore")
        it.templateDir.set("$sourceDir/templates")
        it.configOptions.set(configOptionsMap)
    }
